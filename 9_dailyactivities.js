console.log("Daily Activities JS Loaded");
const taskInput = document.getElementById('adder');
const dateInput = document.getElementById('dlydates');
const taskList = document.getElementById('dlytsklist');
...
if (!userData || userData.purpose !== 'track daily task') {
    alert("Invalid access or purpose mismatch. Redirecting.");
...
function checkTasksDueToday() {
    ...
    if (dueToday.length > 0) {
        alert(`You have ${dueToday.length} daily task(s) due today!`);
    }
}
